...
*/
  [_QW] = LAYOUT_ortho_5x13(
      ...
      UK_BSLS, UK_A   , UK_S    , UK_D   , UK_F    , UK_G  , UK_H  , UK_J  , UK_K     , UK_L   , UK_SCLN, UK_QUOT, KC_ENT  ,
      KC_LSPO, UK_Z   , UK_X    , UK_C   , UK_V    , UK_B  , UK_N  , UK_M  , UK_COMM  , UK_DOT , UK_SLSH, KC_UP  , UK_HASH ,
...
*/
 [_LWR] = LAYOUT_ortho_5x13(
     ...
     _______,  KC_BTN1,XP(lz,lZ),XP(lx,lX),XP(lc,lC),XP(lv,lV),XP(lb,lB),XP(ln,lN),XP(lm,lM),XP(lc1,lC1),XP(lp1,lP1),     KC_PGUP, XP(lq1,lQ1),
     _______,  KC_BTN4,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    KC_HOME,     KC_PGDN,    KC_END),
...
*/
  [_RSE] = LAYOUT_ortho_5x13(
      ...
      _______,  _______,     _______,   XP(rc,rC), _______,   _______,  _______, _______,  _______,   _______, _______, KC_WH_U, _______ ,
