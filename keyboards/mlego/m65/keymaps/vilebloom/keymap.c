...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QW] = LAYOUT_ortho_5x13(
       ...
       KC_NUBS, KC_A   , KC_S    , KC_D   , KC_F    , KC_G  , KC_H  , KC_J  , KC_K    , KC_L   , KC_SCLN, KC_QUOT, KC_ENT  ,
       KC_LSPO, KC_Z   , KC_X    , KC_C   , KC_V    , KC_B  , KC_N  , KC_M  , KC_COMM , KC_DOT , KC_SLSH, KC_UP  , KC_NUHS ,
       KC_LCTL, KC_LGUI, KC_APP  , KC_LALT, TT(_LWR), KC_SPC, KC_SPC, KC_SPC, TT(_RSE), KC_RSPC, KC_LEFT, KC_DOWN, KC_RGHT),
